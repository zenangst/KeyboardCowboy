...
enum SystemWindowRelativeFocus {
  ...
  static func run(_ direction: Direction, snapshot: UserSpace.Snapshot) async throws {
    var windows = await UserSpace.shared.snapshot(resolveUserEnvironment: false).windows.visibleWindowsInStage
